...
import org.jbehavesupport.runner.story.GivenStoryBeforeScenarioStories
...
class GivenStoryBeforeScenarioStoriesTest extends Specification {
    ...
    def "Test correct notifications"() {
        given:
        def runner = new JUnitRunner(GivenStoryBeforeScenarioStories)
    ...
    def "Test descriptions"() {
        ...
        then:
        desc.testClass == GivenStoryBeforeScenarioStories
        children.size() == 3
