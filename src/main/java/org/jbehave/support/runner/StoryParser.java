    ...
    public static class StoryDescription {
        ...
        private Description createStoryDescription(PerformableTree.PerformableStory performableStory) {
            Description description = Description.createSuiteDescription(
                JUnitRunnerFormatter.buildStoryText(JUnitRunnerFormatter.normalizeStoryName(performableStory.getStory().getName())));
            ...
            if (performableScenario.hasExamples()) {
                performableScenario.getExamples()
                    ...
                    .map(examplePerformableScenario -> {
                        Description exampleDescription = Description.createSuiteDescription(
                            JUnitRunnerFormatter.buildExampleText(keywords, examplePerformableScenario.getParameters().toString()));
        ...
        private void addGivenStories(Description scenarioDescription, Scenario scenario) {
            scenario.getGivenStories()
                ...
                .forEach(story -> scenarioDescription.addChild(
                    createTestDescription(Story.class, JUnitRunnerFormatter.normalizeStoryName(story.getPath()))));
        }
